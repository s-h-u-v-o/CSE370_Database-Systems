...
CREATE TABLE Students (
    ...
    CONSTRAINT chk_email CHECK (Email LIKE '%@%.com' OR Email LIKE '%@%.edu'),
...
CREATE TABLE Joine (
    ...
    FOREIGN KEY (Student_ID) REFERENCES Students(Student_ID) ON DELETE CASCADE,
    FOREIGN KEY (Club_ID) REFERENCES Club(Club_ID) ON DELETE CASCADE,
    CONSTRAINT chk_Designation CHECK (Designation IN ('General Member', 'Volunteer', 'Executive'))
);
...
-- Insert Demo Club  
INSERT INTO Club (Name, Department, Office_Room)
VALUES ('Demo Club', 'Computer Science', 'Room 101');
-- Get the generated Club_ID (should be 1)
SET @club_id = LAST_INSERT_ID();

-- Student Demo Account  
INSERT INTO Students (Name, Email, Password, Street, Sub_district, District)
VALUES (
    'Demo Student',
    'student@example.edu',
    'student123',
...
INSERT INTO Students_contact (Student_ID, Phone_Number)
VALUES (@admin_id, '09876543210');

-- Admin as Executive of Demo Club
INSERT INTO Joine (Student_ID, Club_ID, Designation, Join_Date)
VALUES (@admin_id, @club_id, 'Executive', CURDATE());

-- Student as General Member of Demo Club
INSERT INTO Joine (Student_ID, Club_ID, Designation, Join_Date)
VALUES (@student_id, @club_id, 'General Member', CURDATE());

-- Club Email for Demo Club
INSERT INTO Club_Emails (Club_ID, Email)
VALUES (@club_id, 'democlub@example.edu');
...
-- Sample Events  
INSERT INTO Events (Title, Date, Venue, Primary_Club_ID, Description)
VALUES 
('Demo Club Meeting', CURDATE() + INTERVAL 14 DAY, 'Room 101', @club_id, 'First meeting of the semester'),
('Tech Workshop', CURDATE() + INTERVAL 28 DAY, 'Auditorium', @club_id, 'Hands-on workshop on web development');

INSERT INTO Equipments (Name, Type, Status, Owner_Club_ID, Purchase_Date)
VALUES 
('Canon EOS 5D Mark IV', 'Camera', 'Available', 1, '2026-08-15'),
('Epson PowerLite Projector', 'Projector', 'Available', 1, '2026-08-20'),
('Bose L1 Pro8 Speaker', 'Speaker', 'Available', 1, '2026-09-01'),
('Sony UWP-D21 Microphone', 'Microphone', 'Available', 1, '2026-08-10');